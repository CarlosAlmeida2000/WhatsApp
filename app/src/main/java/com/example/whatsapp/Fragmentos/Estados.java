...
import com.example.whatsapp.Adaptadores.EstadosAdapter;
import com.example.whatsapp.Adaptadores.LlamadasAdapter;
...
public class Estados extends Fragment implements Asynchtask {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rcvEstado = (RecyclerView)rootView.findViewById(R.id.rcvEstados);
        rcvEstado.setHasFixedSize(true);
        rcvEstado.setLayoutManager(new LinearLayoutManager(getContext()));
    ...
    public void processFinish(String result) throws JSONException {
        ...
        try {
            ...
            EstadosAdapter adaptadorEstados = new EstadosAdapter(getContext(), lstContactos);
            rcvEstado.setAdapter(adaptadorEstados);
        }
