...
public class Llamadas extends Fragment implements Asynchtask {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rcvLlamada = (RecyclerView)rootView.findViewById(R.id.rcvLlamadas);
        rcvLlamada.setHasFixedSize(true);
        rcvLlamada.setLayoutManager(new LinearLayoutManager(getContext()));
    ...
    public void processFinish(String result) throws JSONException {
        ...
        try {
            ...
            LlamadasAdapter adaptadorLlamadas = new LlamadasAdapter(getContext(), lstContactos);
            rcvLlamada.setAdapter(adaptadorLlamadas);
        }
